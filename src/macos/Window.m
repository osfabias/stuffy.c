...
CAMetalLayer *stuffy__alloc_metal_layer (ContentView *view)
{
  ...
  /**
   * In its implementation of vkGetPhysicalDeviceSurfaceCapabilitiesKHR, MoltenVK
   * takes into consideration both the size (in points) of the bounds, and the
   * contentsScale of the CAMetalLayer from which the Vulkan surface was created.
